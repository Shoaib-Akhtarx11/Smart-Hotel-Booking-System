...
const USER_REDEMPTIONS_KEY = 'redemptions';
 ...
 */
export const getUserRedemptions = (userId) => {
  return loadUserData(userId, USER_REDEMPTIONS_KEY, []);
};

export const saveUserRedemptions = (userId, redemptions) => {
  saveUserData(userId, USER_REDEMPTIONS_KEY, redemptions);
};
...
export const getUserPayments = (userId) => {
  return loadUserData(userId, USER_PAYMENTS_KEY, []);
};
